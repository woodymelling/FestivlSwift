...
public enum FestivlFormatting {
    ...
    public static func weekdayWithDatesFormat(for calendarDate: CalendarDate) -> String {
        weekdayWithDatesFormat(for: calendarDate.date)
    }
    ...
    public static func timeIntervalFormat(_ interval: DateInterval) -> String {
